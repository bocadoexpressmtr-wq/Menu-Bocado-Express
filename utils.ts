            ...
            <div className="p-4 flex-1 flex flex-col">
              ...
              <div className="flex items-center justify-between pt-3 border-t border-stone-50">
                ...
                <div className="flex items-center gap-1">
                  <button onClick={() => { setIsAdding(false); setEditingProduct(product); document.querySelector('main')?.scrollTo({ top: 0, behavior: 'smooth' }); }} className="p-1.5 text-stone-400 hover:text-stone-900 hover:bg-stone-50 rounded-lg transition-all active:scale-90"><Edit2 size={16} /></button>
                  <button onClick={() => handleDelete(product.id)} className="p-1.5 text-stone-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all active:scale-90"><Trash2 size={16} /></button>
                </div>
              </div>
            </div>
          </div>
